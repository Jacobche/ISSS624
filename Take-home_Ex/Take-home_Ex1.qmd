...
Next we will create interactive choropleth maps for both functional and non-functional water points which would allow us to zoom in with a closer look.

```{r}
tmap_mode("view")

func <- tm_shape(nga_wp)+ 
  tm_polygons("wpt functional", 
              style = "equal", 
              palette = "Greens")
...
tmap_arrange(func, nonfunc, asp=1, ncol=1)
