...
```{r}
mpsz = st_read(dsn = "C:/Jacobche/ISSS624/Hands-on_Ex/Hands-on_Ex1/data/geospatial", layer = "MP14_SUBZONE_WEB_PL")
```
...
In this section, we will learn to build hedonic pricing models for condominium resale units using [*lm()*](https://www.rdocumentation.org/packages/stats/versions/3.5.2/topics/lm) of R base.
